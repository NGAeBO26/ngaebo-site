    ...
    <div className="rg-upsell-backdrop" onClick={onClose} role="presentation">
      ...
      >
        ...
        <div className="rg-upsell-split-layout">
          ...
          {/* LEFT PANEL COPY PANEL */}
          <div className="rg-upsell-left-panel-copy">
            {isTokenUser ? (
              <div className="rg-upsell-header-block id-token-header">
                <span className="rg-upsell-badge-pill">
                  🎫 Wallet Balance: {tokenBalance} Credits
                </span>
                
                {/* 🎯 LAYERED DIGITAL TOKEN: Anchors vector coin file directly above background report sheet preview */}
                <div className="rg-upsell-left-preview-frame">
                  <img 
                    src="/data/assets/RideGuide_Sample.png" 
                    alt="Staged Single Track Map Sheet Preview" 
                    className="rg-upsell-left-preview-media"
                  />
                  <img 
                    src="/data/assets/rideguide-token.png" 
                    alt="RideGuide Credit Token Asset Overlay" 
                    className="rg-upsell-preview-token-overlay"
                  />
                </div>
                ...
                {targetRoute ? (
                  <div className="rg-token-activation-content-block">
                    ...
                    <button
                      ...
                      disabled={isProcessingAnyAction}
                      className="rg-upsell-instant-redeem-btn"
                    >
              ...
              <div className="rg-upsell-header-block">
                <h2 id="rg-upsell-title" className="rg-upsell-main-title mod-home-punchy">
                ...
                <p id="rg-upsell-description" className="rg-upsell-subcaption">
                 ...
                 {!isTokenUser && (
              <div className="rg-upsell-matrix-heading">
                Compare and Choose Your Option ➔
              </div>
            )}
          ...
          {/* RIGHT PANEL 2x2 SELECTION FIELD */}
              ...
              {!isTokenUser && (
                <div className="rg-upsell-tier-card mod-current-baseline">
                  <div className="rg-upsell-card-inner">
                    ...
                    <div className="rg-upsell-horizontal-card-body">
                      <div className="rg-upsell-product-image-frame">
                        <img 
                          src="/data/assets/RideGuide_Sample.png" 
                          alt="Staged Single Track Map Sheet Preview" 
                          className="rg-upsell-product-media mod-map-sheet"
                        />
                      </div>
                    ...
                    <button disabled className="rg-upsell-tier-cta-action-btn mod-baseline-btn">
                  ...
                  <div className="rg-upsell-card-inner">
                    ...
                    <div className="rg-upsell-horizontal-card-body">
                      <div className="rg-upsell-product-image-frame">
                        <img 
                          src={tier.imageUrl} 
                          alt={`${tier.title} Token Asset`}
                          className="rg-upsell-product-media"
                          onError={(e) => {
                            (e.target as HTMLImageElement).src = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="%232b7cb6" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><path d="M12 8v8M8 12h8"/></svg>`;
                          }}
                        />
                      </div>
          ...
          <div className="funnel-container">
            <div className="capture-split-layout">
              <div className="capture-text-stack">
                <h3 className="lead-footer-headline">
                  Get Your Free Sample Pack.
                </h3>
                <p className="lead-footer-subcaption">
