        ...
        <div className="rg-upsell-card-inner" style={{ padding: "32px", minHeight: "240px", justifyContent: "center" }}>
          ...
          {isSuccess && (
            <div style={{ textAlign: "center", width: "100%", display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              {state.meta?.downloadUrl ? (
                ...
                <button onClick={onClose} className="rg-upsell-tier-cta-action-btn" style={{ maxWidth: "200px", margin: "12px auto 0 auto" }}>
                  Return to Dashboard
                </button>
              )}
            </div>
          ...
          {isFailure && (
            <div style={{ textAlign: "center", width: "100%", display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              <button onClick={onClose} className="rg-upsell-tier-cta-action-btn" style={{ backgroundColor: "#64748b", maxWidth: "160px", margin: "16px auto 0 auto" }}>
                Dismiss
              </button>
            </div>
          )}
