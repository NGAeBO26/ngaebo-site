...
import "../styles/Legals.css"; // Imports centralized stylesheet rules cleanly
...
export default function Legals() {
  ...
  return (
    // 🎯 THE STRUCTURAL FIXED WRAPPER: Replaces constrained root with a fluid system shell
    <div className="rg-legals-page-fluid-shell" style={{ paddingTop: "40px" }}>
      ...
      <div className="rg-legals-central-canvas" style={{ marginBottom: "60px" }}>
        ...
        {/* ──────────────────────────────────────────────────────────────────
            ...
            ────────────────────────────────────────────────────────────────── */}
        <section id="terms" className="rg-legals-section-large">
          <h2 className="rg-legals-heading-2">1. Terms & Conditions</h2>
          ...
          <h3 className="rg-legals-heading-3">1.9 Mapping, Terrain, and Safety Disclaimer</h3>
          ...
          <h3 className="rg-legals-heading-3">1.10 Limitation of Liability</h3>
          <p className="rg-legals-body-text">
          ...
          <h3 className="rg-legals-heading-3">1.11 DMCA / Copyright Policy</h3>
          <p className="rg-legals-body-text">
          ...
          <h3 className="rg-legals-heading-3">1.12 Governing Law & Changes</h3>
          <p className="rg-legals-body-text">
        ...
        {/* ──────────────────────────────────────────────────────────────────
            ...
            ────────────────────────────────────────────────────────────────── */}
        <section id="privacy" className="rg-legals-section-large">
          <h2 className="rg-legals-heading-2">2. Privacy Policy</h2>
          <p className="rg-legals-body-text">
        ...
        {/* ──────────────────────────────────────────────────────────────────
            ...
            ────────────────────────────────────────────────────────────────── */}
        <section id="affiliate" className="rg-legals-section-small">
          <h2 className="rg-legals-heading-2">3. Affiliate Disclosure (FTC Compliance)</h2>
          <p className="rg-legals-body-text">
      ...
      </div>{/* 🎯 THE STRUCTURAL FIX: Closing the canvas card wrapper here frees the element below to fill 100% viewport width */}
